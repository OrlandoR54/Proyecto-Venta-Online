            ...
            <div class="w3-container" id="aceite">
                ...
                <div class="w3-row w3-grayscale">
                    <div class="w3-col l3 s6">
                        <div class="w3-container  tam">
                            <div class="w3-display-container">
                                <a href="calificacion/calificacion.php?codigo=2"><img class="produc"
                        ...
                        <div class="w3-container">
                            <div class="w3-display-container">
                                ...
                                <a href="calificacion/calificacion.php?codigo=5"><img class="produc"
                    ...
                    <div class="w3-col l3 s6 tam">
                        <div class="w3-container">
                            <div class="w3-display-container">
                                <a href="calificacion/calificacion.php?codigo=1"><img class="produc" src="../../images/aceitecbd-5.jpg"
                                        style="width:100%"></a>
                        ...
                        <div class="w3-container">
                            <div class="w3-display-container">
                                <a href="calificacion/calificacion.php?codigo=12"><img class="produc"
                    ...
                    <div class="w3-col l3 s6 tam">
                        <div class="w3-container">
                            <div class="w3-display-container">
                                <a href="calificacion/calificacion.php?codigo=3"><img class="produc" src="../../images/aceite-cbd-xl.png"
                                        style="width:100%"></a>
                                <div class="w3-display-middle w3-display-hover">
                        ...
                        <div class="w3-container">
                            <div class="w3-display-container">
                                <a href="calificacion/calificacion.php?codigo=6"><img class="produc" src="../../images/Aceite-CBD-5.jpg"
                                        style="width:100%"></a>
                    ...
                    <div class="w3-col l3 s6 tam">
                        <div class="w3-container">
                            <div class="w3-display-container">
                                <a href="calificacion/calificacion.php?codigo=4"><img class="produc" src="../../images/Aceite-CBD-5-500mg.jpg"
                                        style="width:100%"></a>
                                <div class="w3-display-middle w3-display-hover">
                        ...
                        <div class="w3-container">
                            <div class="w3-display-container">
                                <a href="calificacion/calificacion.php?codigo=7"><img class="produc" src="../../images/Aceite-CBD-2.5.jpg"
                                        style="width:100%"></a>
                                <div class="w3-display-middle w3-display-hover">
                ...
                <div class="w3-row w3-grayscale">
                    <div class="w3-col l3 s6">
                        <div class="w3-container  tam">
                            <div class="w3-display-container">
                                <span class="w3-tag w3-display-topleft">New</span>
                                <a href="calificacion/calificacion.php?codigo=8"> <img class="produc" src="../../images/crema-cbd-forte.jpg"
                                        style="width:100%"></a>
                                <div class="w3-display-middle w3-display-hover">
                    ...
                    <div class="w3-col l3 s6 tam">
                        <div class="w3-container">
                            <div class="w3-display-container">
                                <a href="calificacion/calificacion.php?codigo=9"><img class="produc"
                    ...
                    <div class="w3-col l3 s6 tam">
                        <div class="w3-container">
                            <div class="w3-display-container">
                                <a href="calificacion/calificacion.php?codigo=10"><img class="produc"
                    ...
                    <div class="w3-col l3 s6 tam">
                        <div class="w3-container">
                            <div class="w3-display-container">
                                <a href="calificacion/calificacion.php?codigo=11"><img class="produc"
